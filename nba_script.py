...
parser.add_argument('--image_width', default=640, type=int, help='image width to resize to')
parser.add_argument('--image_height', default=360, type=int, help='image height to resize to')
parser.add_argument('--clip_length', default=72, type=int, help='length of a clip in this dataset in frames')
parser.add_argument('--num_classes', default=9, type=int, help='number of activity classes')
...
parser.add_argument('--num_windows', default=14, type=int, help='number of windows per clip to be fed into the network when using sparse sampling')
...
parser.add_argument('--num_tokens', default=18, type=int, help='window size')
